...
export default function PetDemo() {
  ...
  return (
    <section
      ...
      style={{ position: 'relative', overflow: 'hidden', paddingInline: '24px' }}
    >
      <div
        aria-hidden="true"
        style={{
          ...
          width: '600px',
          height: '400px',
          background: 'radial-gradient(ellipse, oklch(74% 0.16 78 / 0.07) 0%, transparent 70%)',
          pointerEvents: 'none',
        }}
      />
      ...
      <div style={{ maxWidth: '900px', margin: '0 auto', position: 'relative', zIndex: 1 }}>
        <div style={{ textAlign: 'center', marginBottom: '56px' }}>
          ...
          <h2
            id="demo-heading"
            style={{
              fontSize: 'var(--text-xl)', fontWeight: 700, letterSpacing: '-0.025em',
              color: 'var(--color-text)', marginBottom: '14px',
            }}
          >
            Meet your new companion
          </h2>
          <p style={{ fontSize: 'var(--text-lg)', color: 'var(--color-text-muted)', maxWidth: '400px', margin: '0 auto', lineHeight: 1.6 }}>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', justifyContent: 'center' }}>
            ...
            >
              <div style={{
                ...
                minHeight: '300px',
                padding: '24px',
                background: 'radial-gradient(ellipse 70% 60% at 50% 75%, oklch(74% 0.16 78 / 0.07) 0%, transparent 70%)',
                position: 'relative',
              }}>
                <div
                  aria-hidden="true"
          ...
          <div>
            <p style={{
              fontSize: '0.71875rem', fontWeight: 600, letterSpacing: '0.06em',
              ...
              {STATES_LIST.map(({ state, label, hint }) => (
                <button
                  ...
                  style={{
                    ...
                    background: petState === state ? 'var(--color-accent-dim)' : 'oklch(100% 0 0 / 0.03)',
                ...
                >
                  <span style={{
                    ...
                    color: petState === state ? 'var(--color-accent)' : 'var(--color-text)',
                  }}>
                    {label}
                  </span>
                  <span style={{ fontSize: '0.71875rem', color: 'var(--color-text-dim)' }}>
                    {hint}
                  </span>
                </button>
              ))}
